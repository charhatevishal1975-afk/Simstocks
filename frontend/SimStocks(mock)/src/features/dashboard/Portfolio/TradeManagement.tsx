      ...
      <div className="flex gap-4">
        <button
          ...
          className={`flex-1 py-3 rounded-xl font-bold border-2 transition ${
            mode === "stops" ? "bg-[#3B9DF2] text-white border-[#3B9DF2]" : "bg-white text-black border-black"
          }`}
        >
          ◯ Stops
        </button>
        <button
          ...
          className={`flex-1 py-3 rounded-xl font-bold border-2 transition ${
            mode === "close" ? "bg-[#3B9DF2] text-white border-[#3B9DF2]" : "bg-white text-black border-black"
          }`}
        >
          ☑ Close
        </button>
        ...
        {mode === "close" ? (
          <div className="grid grid-cols-2 gap-8 items-center">
            <div className="space-y-1">
              <p className="text-gray-400 font-bold text-xs uppercase tracking-widest">Profit</p>
              <p className="text-5xl font-black text-emerald-500">+₹10.00</p>
              <p className="text-emerald-500 font-bold text-sm">+0.11%</p>
            </div>
            <div className="flex flex-col justify-end items-end space-y-4">
              <div className="text-right text-xs font-bold text-gray-500 space-y-1">
                <p>Open Price: <span className="text-black">₹100</span></p>
                <p>Current Price: <span className="text-black">₹1010</span></p>
                <p>Commission: <span className="text-black">₹0.00</span></p>
              </div>
              <button 
                onClick={onOpenModal}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-bold text-gray-500 uppercase">Stop Loss</label>
                  <span className="text-red-500 font-black text-lg">{stopLoss}%</span>
                </div>
                <input 
                  type="range" 
                  min="-50" max="0" step="1"
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <label className="text-sm font-bold text-gray-500 uppercase">Take Profit</label>
                  <span className="text-emerald-500 font-black text-lg">+{takeProfit}%</span>
                </div>
                <input 
                  type="range" 
